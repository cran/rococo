...
\begin{center}
<<LargeNoShufflesPic,fig=TRUE,echo=TRUE,width=5,height=5>>=
...
\subsection{Upgrading to Version 1.1.1}

Users who upgrade to Version 1.1.1 from an older version should be aware that
...
\begin{quotation}
\noindent U. Bodenhofer, M. Krone, and F. Klawonn (2012).
Testing noisy numerical data for monotonic association.
{\em Inform. Sci.}, DOI: 10.1016/j.ins.2012.11.026.\\[5mm]
